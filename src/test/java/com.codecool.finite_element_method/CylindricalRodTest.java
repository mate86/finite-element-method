...
class CylindricalRodTest {
    @Test
    void testCreatingNewCylindricalRod() {
    ...
    @Test
    void testLengthOfCylindricalPointList() {
        RodFactory rodFactory = new RodFactory();
        Rod rod = rodFactory.getRod(Shape.CIRCLE, 10, 50.0, 2.0E-2, 2.0E11);
    ...
    @Test
    void testDeformingCynlindricalRod() {
        RodFactory rodFactory = new RodFactory();
        Rod rod = rodFactory.getRod(Shape.CIRCLE, 11, 1.0, 2.0E-2, 2.0E11);
